"""CLI wrapper for the guarded disposable PostgreSQL migration rehearsal."""
...
def main() -> int:
    ...
    report = {"report_version": "sentinel-dna-postgresql-migration.v1", **run_migration(backend), **report_metadata(REPO_ROOT)}
