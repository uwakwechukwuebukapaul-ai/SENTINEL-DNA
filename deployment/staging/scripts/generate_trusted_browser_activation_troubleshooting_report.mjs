...
const REMEDIATION = Object.freeze({
  ...
  browser_auth_available: ["browser_auth_capability", "TB_AUTH_CAPABILITY_MISSING", "Restore the external browserAuth capability; do not pass credentials another way."],
