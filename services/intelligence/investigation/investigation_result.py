...
class InvestigationResult:
    ...
    compliance_context: Any = None

    asset_context: Any = None

    vulnerability_context: Any = None

    security_graph_context: Any = None
    ...
    threat_hunting_context: Any = None

    exposure_management_context: Any = None
    ...
    investigation_quality_context: Any = None
    ...
    def to_dict(
        ...
        return {
            ...
            "threat_hunting_context": self.threat_hunting_context,
            ...
            "investigation_quality_context": self.investigation_quality_context,

            "compliance_monitoring_context": self.compliance_monitoring_context,
