...
class IntegrationService:
    ...
    def register(self,connector): self.connectors[connector.connector_id]=connector; self.audit.record("connector_created",connector_id=connector.connector_id); return connector
