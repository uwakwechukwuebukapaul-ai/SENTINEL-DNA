...
class OnboardingState:
    ...
    NEW = "NEW"
    VERIFICATION_METHOD_SELECTED = "VERIFICATION_METHOD_SELECTED"
    ...
    TRANSITIONS = {
        NEW: {VERIFICATION_METHOD_SELECTED, EMAIL_VERIFICATION_REQUIRED},
        VERIFICATION_METHOD_SELECTED: {VERIFICATION_SENT},
        VERIFICATION_SENT: {VERIFIED},
        VERIFIED: {PROFILE_REQUIRED},
        ...
        WORKSPACE_READY: {MFA_ENROLLMENT_REQUIRED, AUTHENTICATED},
        MFA_ENROLLMENT_REQUIRED: {AUTHENTICATED},
        AUTHENTICATED: set(),
    }
