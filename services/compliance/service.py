class ComplianceService:
    ...
    def get_security_posture(self,tenant_id,**kwargs): return self.risk_engine.calculate(tenant_id,compliance_gaps=len(self.evaluator.generate_gap_report(self.repository.list_assessments(tenant_id))),**kwargs)
