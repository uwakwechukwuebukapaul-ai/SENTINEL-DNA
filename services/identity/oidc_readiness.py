...
class OidcDeploymentReadinessValidator:
    ...
    def validate(self, configuration: OidcRuntimeConfiguration | None = None):
        ...
        if not importlib.util.find_spec("jwt"): return OidcDeploymentReadiness("CONFIGURATION_INVALID", "oidc_verifier_unavailable")
        ...
        return OidcDeploymentReadiness("READY", "configuration_ready", ("configuration", "secret", "verifier", "trust"))
